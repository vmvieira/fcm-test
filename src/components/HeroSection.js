  ...
  return (
    <section className="relative h-screen">
      <div className="grid grid-flow-row mb-10 h-screen lg:grid-flow-col">
        <h1 className="pt-8 text-lg align-middle text-center lg:absolute lg:text-3xl lg:pt-36 inset-0">
          Soluções <em>especializadas</em> para os clássicos e novos desafios.
        </h1>
        <div className="classic to-right table w-full h-full">
        ...
        <div className="creative to-left table w-full h-full">
